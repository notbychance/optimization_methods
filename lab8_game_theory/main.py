...
from game_theory import BimatrixGameSolver, DecisionCriteriaSolver, MatrixGameSolver
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description='ЛР 8. Теория игр и принятия решений: матричные игры, критерии решений, биматричные игры.'
    )
    parser.add_argument(
        '--input',
        '-i',
